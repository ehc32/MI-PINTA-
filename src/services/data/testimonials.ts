...
export interface Testimonial {
  id: number
  name: string
  avatar: string // Ahora contendrá el nombre del icono a utilizar
  testimonial: string
  service: string
  rating: number
...
// Datos de testimonios con iconos en lugar de rutas de imágenes
export const testimonialsList: Testimonial[] = [
  {
    id: 1,
    name: "María García",
    avatar: "https://img.freepik.com/vector-premium/arte-vectorial-icono-interfaz-perfil_1015832-3774.jpg?semt=ais_hybrid&w=740", // Icono de Lucide React
